...
if change // 100 > 0:
    coins = change // 100
    print(f"{coins} x 1 lev")
    change = change - (coins * 100)
if change // 50 > 0:
    coins = change // 50
    print(f"{coins} x 50 stotinki")
    change = change - (coins * 50)
if change // 20 > 0:
    coins = change // 20
    print(f"{coins} x 20 stotinki")
    change = change - (coins * 20)
if change // 10 > 0:
    coins = change // 10
    print(f"{coins} x 10 stotinki")
    change = change - (coins * 10)
if change // 5 > 0:
    coins = change // 5
    print(f"{coins} x 5 stotinki")
    change = change - (coins * 5)
if change // 2 > 0:
    coins = change // 2
    print(f"{coins} x 2 stotinki")
    change = change - (coins * 2)
if change // 1 > 0:
    coins = change // 1
    print(f"{coins} x 1 stotinka")
